...
-- Create a shortcut to remove carriage returns (^M characters)
-- Press <leader>cr in Normal mode to use it
vim.keymap.set('n', '<leader>cr', ':%s/\\r//g<CR>', {
  noremap = true,
  silent = true,
  desc = 'Remove carriage returns (Fix DOS file)',
})
...
require('lazy').setup({
  ...
  --
  change_detection = {
    enabled = false, -- Set to false to disable auto-reloading
  },
